...
class HrController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        $employees = DB::table('employees')
            ...
            if ($request->ajax()) {
                return view('hr.dashboard', compact('employees'))->render();
            }


        //dd($employees);
        //$employees = Employee::all(); // Fetch all employees
        return view('hr.dashboard', compact('employees'));   
    } 
     ...
     public function create()
    {
        ...
        // session (Step) -compact for all fields
        ...
        return view('hr.employe.create' , compact('combinedLeads', 'all_skills'));
    }
...
if ($request->hasFile('profile_image')) {
    ...
    $updateData['profile_image'] = $storedPath;
        ...
        return response()->json(['success' => true, 'message' => 'Update setp 1']);
...
public function editStep5(Request $request)
{
    ...
    if ($request->has('documents')) {
        foreach ($request->documents as $i => $doc) {
            ...
            if ($uploadedFile) {
                ...
                $fileName = "{$cleanName}-{$safeDocType}." . $extension;
    ...
    public function edit($id)
    {
      ...
      $employee = DB::table('employees')
            ...
            // Add team leads (need to get corresponding user_id)
            foreach ($teamLeads as $team) {
                // Get corresponding user using employee_id
                $user = User::where('employee_id', $team->id)->first();
        ...
        return view('hr.employe.edit', compact('employee', 'id','combinedLeads', 'firstName', 'lastName', 'disableRoleChange'));
    ...
    public function update(Request $request, Employee $employee)
    {
        ...
        return redirect()->route('hr.employe.index')->with('success', 'Employee updated successfully.');
    }
 ...
 $upcomingBirthdays = DB::table('employees')
    ...
    ->get();
        ...
        $upcomingHolidays = Holiday::whereBetween('holiday_date', [Carbon::today(), Carbon::today()->addDays(30)])
            ...
            ->get();
        //$employees = Employee::all(); // Fetch all employees
        return view('hr.index', compact('todayBirthdays', 'upcomingBirthdays', 'upcomingHolidays'));
    } 
...
private function parseDocuments(Request $request)
{
    ...
    public function view($id)
    {
       ...
       //$employee = Employee::findOrFail($id);
        ...
        return view('hr.employe.view', compact('employee', 'all_skills', 'team_lead', 'salary'));
    }
}    
