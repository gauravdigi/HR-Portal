                            ...
                            <div class="skill-group">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3 mt-4">
                                        <button type="button" onclick="removeSkillField(this)" class="btn btn-danger remove-skill">–</button>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if (!empty($doc['file_path']))
                                            <small class="viewfileCurrent">Current file: <a href="
                                                {{ asset('storage/' . $doc['file_path']) }}" target="_blank" download class="viewfile"><i class="bi bi-file-earmark-text"></i></a></small>
...
<script>
    ...
    function nextStep(step) {
        ...
        if (step == 1) {
            ...
            jQuery('.ApWait').show(); 
            $.ajax({
                url: '/hrportalv2/hr/employe/edit-step1',
                type: 'POST',
                data: formData,
...
jQuery('.ApWait').show(); 
            $.ajax({
                url: '/hrportalv2/hr/employe/edit-step2',
                type: 'POST',
                data: formData,
                contentType: false,      // ✅ Do not set content type manually
                processData: false,      // ✅ Prevent jQuery from converting the FormData
...
jQuery('.ApWait').show(); 
            $.ajax({
                url: '/hrportalv2/hr/employe/edit-step3',
                type: 'POST',
                data: formData,
                contentType: false,      // ✅ Do not set content type manually
                processData: false,      // ✅ Prevent jQuery from converting the FormData
 ...
 $('.skill-group').each(function (index) {
            ...
            $.ajax({
                url: '/hrportalv2/hr/employe/edit-step4',
                type: 'POST',
                data: formData,
                contentType: false,      // ✅ Do not set content type manually
                processData: false,      // ✅ Prevent jQuery from converting the FormData
...
jQuery('.ApWait').show(); 
            $.ajax({
                url: '/hrportalv2/hr/employe/edit-step5',
                type: 'POST',
                data: formData,
                contentType: false,      // ✅ Do not set content type manually
                processData: false,      // ✅ Prevent jQuery from converting the FormData
...
jQuery('.ApWait').show(); 
            $.ajax({
                url: '/hrportalv2/hr/employe/edit-step6',
                type: 'POST',
                data: formData,
                contentType: false,      // ✅ Do not set content type manually
                processData: false,      // ✅ Prevent jQuery from converting the FormData
